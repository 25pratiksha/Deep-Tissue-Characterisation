function [net, info] = IVUS_DAGNN_3B_FC_L2(imdb,inpt)
...
%     
    ...
    net.addLayer('fc', dagnn.Conv('size', [1 1 64 512], 'hasBias', true, 'stride', [1, 1], 'pad', [0 0 0 0]), {'pool2'}, {'fcOut'},  {'fcf'  'fcb'});
	net.addLayer('reluFC', dagnn.ReLU(), {'fcOut'}, {'reluFC'}, {});
    
    % Decoder Block 4
    
    net.addLayer('deconv4', dagnn.ConvTranspose('size', [3 3 64 512], 'hasBias', true, 'upsample', [2,2], 'crop', [1 0 1 0]), {'reluFC'}, {'deconv4'},  {'deconv4f'  'deconv4b'});
	net.addLayer('bn4', dagnn.BatchNorm('numChannels', 64), {'deconv4'}, {'bn4'}, {'bn4f', 'bn4b', 'bn4m'});
	net.addLayer('relu4', dagnn.ReLU(), {'bn4'}, {'relu4'}, {});
    
    
	net.addLayer('deconv5', dagnn.ConvTranspose('size', [7 7 64 64], 'hasBias', true, 'upsample', [2,2], 'crop', [5 0 5 0]), {'relu4'}, {'deconv5'},  {'deconv5f'  'deconv5b'});
...
% 	net.addLayer('relu6', dagnn.ReLU(), {'bn6'}, {'relu6'}, {});
    ...
    net.addLayer('drop1', dagnn.DropOut('rate', 0.7), {'relu5'}, {'drop1'}, {});
